 ...
 *
 */
export type public_v_produit_categorie_attributModel =
	runtime.Types.Result.DefaultSelection<Prisma.$public_v_produit_categorie_attributPayload>;
...
export type Public_v_produit_categorie_attributAggregateArgs<
...
> = {
	 ...
	 */
	orderBy?:
		| Prisma.public_v_produit_categorie_attributOrderByWithRelationInput
		| Prisma.public_v_produit_categorie_attributOrderByWithRelationInput[];
	/**
...
export type GetPublic_v_produit_categorie_attributAggregateType<
	T extends Public_v_produit_categorie_attributAggregateArgs
> = {
...
export type public_v_produit_categorie_attributGroupByArgs<
	ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs
> = {
	where?: Prisma.public_v_produit_categorie_attributWhereInput;
	orderBy?:
		| Prisma.public_v_produit_categorie_attributOrderByWithAggregationInput
		| Prisma.public_v_produit_categorie_attributOrderByWithAggregationInput[];
	by:
		| Prisma.Public_v_produit_categorie_attributScalarFieldEnum[]
		| Prisma.Public_v_produit_categorie_attributScalarFieldEnum;
...
type GetPublic_v_produit_categorie_attributGroupByPayload<
...
> = Prisma.PrismaPromise<
	Array<
		Prisma.PickEnumerable<Public_v_produit_categorie_attributGroupByOutputType, T['by']> & {
			[P in keyof T &
				keyof Public_v_produit_categorie_attributGroupByOutputType]: P extends '_count'
				? T[P] extends boolean
					? number
...
export type public_v_produit_categorie_attributWhereInput = {
	AND?:
		| Prisma.public_v_produit_categorie_attributWhereInput
		| Prisma.public_v_produit_categorie_attributWhereInput[];
...
export type public_v_produit_categorie_attributScalarWhereWithAggregatesInput = {
	AND?:
		| Prisma.public_v_produit_categorie_attributScalarWhereWithAggregatesInput
		| Prisma.public_v_produit_categorie_attributScalarWhereWithAggregatesInput[];
...
export type public_v_produit_categorie_attributSelect<
	ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs
...
export type public_v_produit_categorie_attributOmit<
	ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs
...
export type $public_v_produit_categorie_attributPayload<
	ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs
> = {
...
export type public_v_produit_categorie_attributGetPayload<
	S extends boolean | null | undefined | public_v_produit_categorie_attributDefaultArgs
> = runtime.Types.Result.GetResult<Prisma.$public_v_produit_categorie_attributPayload, S>;

export type public_v_produit_categorie_attributCountArgs<
	ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs
> = Omit<
	public_v_produit_categorie_attributFindManyArgs,
	'select' | 'include' | 'distinct' | 'omit'
> & {
	select?: Public_v_produit_categorie_attributCountAggregateInputType | true;
};

export interface public_v_produit_categorie_attributDelegate<
	ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
	GlobalOmitOptions = {}
> {
	[K: symbol]: {
		types: Prisma.TypeMap<ExtArgs>['model']['public_v_produit_categorie_attribut'];
		meta: { name: 'public_v_produit_categorie_attribut' };
	};
	/**
	 ...
	 */
	findFirst<
		T extends public_v_produit_categorie_attributFindFirstArgs,
		...
		SkipDependenciesValidator extends 'skip' extends Prisma.Keys<T>
			...
			: {}
	>(
		args?: Prisma.SelectSubset<T, public_v_produit_categorie_attributFindFirstArgs<ExtArgs>> &
			TakeDependenciesValidator &
			SkipDependenciesValidator
	): Prisma.Prisma__public_v_produit_categorie_attributClient<
		runtime.Types.Result.GetResult<
			Prisma.$public_v_produit_categorie_attributPayload<ExtArgs>,
			T,
			'findFirst',
			GlobalOmitOptions
		> | null,
	 ...
	 */
	findFirstOrThrow<
		T extends public_v_produit_categorie_attributFindFirstOrThrowArgs,
		TakeDependenciesValidator extends 'take' extends Prisma.Keys<T>
			? {
					orderBy: {};
				}
	...
	>(
		args?: Prisma.SelectSubset<
			T,
			public_v_produit_categorie_attributFindFirstOrThrowArgs<ExtArgs>
		> &
			TakeDependenciesValidator &
			SkipDependenciesValidator
	): Prisma.Prisma__public_v_produit_categorie_attributClient<
	 ...
	 */
	findMany<
		T extends public_v_produit_categorie_attributFindManyArgs,
		TakeDependenciesValidator extends 'take' extends Prisma.Keys<T>
			? {
					orderBy: {};
				}
		...
		SkipDependenciesValidator extends 'skip' extends Prisma.Keys<T>
			...
			: {}
	>(
		args?: Prisma.SelectSubset<T, public_v_produit_categorie_attributFindManyArgs<ExtArgs>> &
			TakeDependenciesValidator &
			SkipDependenciesValidator
	): Prisma.PrismaPromise<
		runtime.Types.Result.GetResult<
		...
		T extends runtime.Types.Utils.Record<'select', any>
			? T['select'] extends true
				...
				: Prisma.GetScalarType<
						T['select'],
						Public_v_produit_categorie_attributCountAggregateOutputType
					>
			: number
	>;
	 ...
	 * })
	 **/
	aggregate<T extends Public_v_produit_categorie_attributAggregateArgs>(
		args: Prisma.Subset<T, Public_v_produit_categorie_attributAggregateArgs>
	): Prisma.PrismaPromise<GetPublic_v_produit_categorie_attributAggregateType<T>>;
	...
	>(
		args: Prisma.SubsetIntersection<T, public_v_produit_categorie_attributGroupByArgs, OrderByArg> &
			InputErrors
	): {} extends InputErrors
		? GetPublic_v_produit_categorie_attributGroupByPayload<T>
 ...
 */
export interface Prisma__public_v_produit_categorie_attributClient<
	T,
	Null = never,
	ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
	GlobalOmitOptions = {}
 ...
 */
export type public_v_produit_categorie_attributFindFirstArgs<
	ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs
> = {
	/**
 ...
 */
export type public_v_produit_categorie_attributFindFirstOrThrowArgs<
	ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs
> = {
	/**
	 * Select specific fields to fetch from the public_v_produit_categorie_attribut
 ...
 */
export type public_v_produit_categorie_attributFindManyArgs<
	ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs
> = {
	/**
	 * Select specific fields to fetch from the public_v_produit_categorie_attribut
 ...
 */
export type public_v_produit_categorie_attributDefaultArgs<
	ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs
> = {
	/**
	 * Select specific fields to fetch from the public_v_produit_categorie_attribut
